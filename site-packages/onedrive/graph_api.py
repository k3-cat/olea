...
class Graph():
    def __init__(self, config):
        ...
        authority = config.get('GRAPH_AUTHORITY', AUTHORITY)
        self.endpoint = config.get('GRAPH_ENDPOINT', ENDPOINT)
        self.scopes = ['Files.ReadWrite.All']

        self.token_cache = TokenCache(path=config['GRAPH_TOKEN_FILE_PATH'])
        self.cca = msal.ConfidentialClientApplication(
            client_id,
            authority=authority,
