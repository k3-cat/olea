...
class CacheField(type):
    ...
    def __call__(self, *args, **kwargs):
        trait = list(args)
        trait.extend(kwargs.get('required', True))
        trait.extend(kwargs.get('nullable', False))
...
class DateTime(String):
    ...
    def wrap_data(self, data, errors, extra):
        ...
        if data:
            return (datetime.datetime.fromisoformat(data), errors)
        return (data, errors)
...
class Date(String):
    ...
    def wrap_data(self, data, errors, extra):
        ...
        if data:
            return (datetime.date.fromisoformat(data), errors)
        return (data, errors)
...
class Time(String):
    ...
    def wrap_data(self, data, errors, extra):
        ...
        if data:
            return (datetime.time.fromisoformat(data), errors)
        return (data, errors)
