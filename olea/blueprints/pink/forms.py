...
from json_api.fields import Boolean, Enum, Integer, List, Set, String
from json_api.logic_opt import AnyOf, Has, If, Is, OneOf, Properties
...
class UpdateInfo(BaseForm):
    ...
    _condition = AnyOf(Has('qq'), Has('other'))
