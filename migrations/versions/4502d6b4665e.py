...
proj_state = postgresql.ENUM('pre', 'freezed', 'working', 'upload', 'fin', name='proj_state', create_type=False)
pit_state = postgresql.ENUM('init', 'pending', 'working', 'delayed', 'past_due', 'auditing', 'fin', 'fin_p', 'droped', name='pit_state', create_type=False)
...
def upgrade():
    ...
    proj_state.create(bind=op.get_bind())
    pit_state.create(bind=op.get_bind())
    ...
    sa.Column('state', proj_state, nullable=False),
    ...
    sa.Column('pink_id', sa.String(), nullable=False),
    sa.Column('state', pit_state, nullable=False),
    sa.Column('start_at', sa.DateTime(), nullable=True),
    sa.Column('finish_at', sa.DateTime(), nullable=True),
...
def downgrade():
    ...
    proj_state.drop(bind=op.get_bind())
    pit_state.drop(bind=op.get_bind())
